...
# Example usage
file_path = './res/image.jpg'  # Replace with your file path
output_dir = './res/'  # Directory to save pieces
all_hashes = divide_file_and_generate_hashes(file_path, output_dir)

# Display concatenated hashes (as hex)
print(f"Concatenated hashes: {all_hashes.hex()}")
